#!/bin/bash
# My Telegram : https://t.me/Asrolka
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
<!DOCTYPE html>
<html lang="en">
<!-- Simple OVPN Download site by Rolkos Project -->
  <head><center><center>
  <meta charset="utf-8" />
  <title>ROLKOS PROJECT</title>
...
<h2 class="h1"><i class="fa fa-desktop"><span style="color:yellow">Rolkos Project</i></h2>
...
<div class="container justify-content-center" style="margin-top:9em;margin-bottom:5em;">
<th><br><div class="card"><div class="card-body"><h5 class="card-title"><span class="badge light-blue darken-4">OpenVPN Config Download</span><p class='info'>🔰 COPYRIGHT © 2023 by Rolka Project 🔰<br/>🔰Website Powered By Rolka Project 🔰<br /></h5></br></p></div></div></th>
</html>
